...
const impacts = [
  ...
  {
    icon: <GraduationCap size={32} color="#C9A96E" />,
  ...
  {
    icon: <Home size={32} color="#C9A96E" />,
  ...
  {
    icon: <TreePine size={32} color="#C9A96E" />,
...
export default function CSRSection() {
  ...
  return (
    <section id="mission" style={{ padding: '6rem 2rem', background: '#F4F1DE' }} ref={ref}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ marginTop: '1.5rem', display: 'flex', alignItems: 'center', gap: '1rem' }}>
                <div style={{ width: '48px', height: '48px', background: 'rgba(201, 169, 110, 0.2)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          {impacts.map((impact, i) => (
            <div
              ...
              style={{
                ...
                transition: `opacity 0.7s ${0.3 + i * 0.1}s ease, transform 0.7s ${0.3 + i * 0.1}s ease`,
              }}
            >
              <div style={{ width: '60px', height: '60px', background: 'linear-gradient(135deg, #D8F3DC, #B7E4C7)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1.25rem' }}>
                {impact.icon}
              </div>
              <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.1rem', fontWeight: 600, color: '#1B4332', marginBottom: '0.75rem' }}>{impact.title}</h3>
              <p style={{ fontSize: '0.85rem', color: '#6B7280', lineHeight: 1.65 }}>{impact.description}</p>
              <div style={{ marginTop: '1.25rem', paddingTop: '1.25rem', borderTop: '1px solid rgba(216, 243, 220, 0.8)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <div>
                  ...
                  <div style={{ fontSize: '0.65rem', color: '#9ca3af', letterSpacing: '0.1em', textTransform: 'uppercase' }}>{impact.highlightLabel}</div>
                </div>
                <ArrowRight size={18} color="#2D6A4F" />
              </div>
            </div>
          ))}
        </div>
